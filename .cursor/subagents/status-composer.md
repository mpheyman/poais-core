...
- **Files updated** — paths modified (typically the product folder’s STATUS.md, e.g. `product/STATUS.md`, or `portfolio/STATUS.md` when target is portfolio).
