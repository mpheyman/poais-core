...
Compare POAIS artifacts (CONTEXT, PLAN, EXECUTION, DECISIONS; optionally ROADMAP and portfolio PRIORITIES) and produce an Alignment Report. Uses the alignment_check skill. **Only auto-apply low-risk consistency fixes** (e.g. link, heading); all other fixes are proposed for user approval.
...
1. Read CONTEXT, PLAN, EXECUTION, DECISIONS (and optional ROADMAP, portfolio/PRIORITIES).
